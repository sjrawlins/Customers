        ...
        public override string Load(string uri, Dictionary<string, string> parameters)
        {
            ...
            if (Model == null)
            {
                ...
                Model.Customers = new List<Customer> {
                  new Customer() { Name = "Apple", CustomerID = "1", Phone = "(982) 229-5630", EmailAddress = "tim@apple.com", RegionCode = RegionCodes.West, Score = 52, },
                  new Customer() { Name = "Google", CustomerID = "2", Phone = "(982) 665-8800", EmailAddress = "jon@google.com", RegionCode = RegionCodes.East, Score = 17, },
                  new Customer() { Name = "Microsoft",CustomerID = "3", Phone = "(789) 444-6000", EmailAddress = "sally@microsoft.com", RegionCode = RegionCodes.South, Score = 82, },
                  new Customer() { Name = "Xamarin",CustomerID = "4", Phone = "(988) 789-0123", EmailAddress = "nat@xamarin.com", RegionCode = RegionCodes.North, Score = 72, },
                  new Customer() { Name = "Zebra", CustomerID = "5", Phone = "(651) 456-7890", EmailAddress = "anders@zebra.com", RegionCode = RegionCodes.Central, Score = 99, },
                };
